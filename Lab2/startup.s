...
;******************************************************************************
        ...
        THUMB	
				...
				EXTERN NextRun	; next thread to run
				EXTERN OS_Scheduler	; scheduler
...
SysTick_Handler                ; 1) Saves R0-R3,R12,LR,PC,PSR
	...
	PUSH    {LR}                 ;    *Save LR before call scheduler
	
	BL      OS_Scheduler       ;  call the scheduler
	LDR		R2, =NextRun       ; 7) R2= pointer to NextRun
	LDR     R1, [R2]           ;    R1= NextRun
